...
-- Postgres, so without this a second run of this file (e.g. via `supabase db push` re-applying
-- an already-migrated database) fails with "policy already exists" instead of being a no-op.
